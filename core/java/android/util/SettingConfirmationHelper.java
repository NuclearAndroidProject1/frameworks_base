...
public class SettingConfirmationHelper {
    ...
    public static void request(final Context context, final String setting,
            ...
            final String dialog_message_one, final String dialog_message_two, final String dialog_just_once,
        ...
        builder.setPositiveButton(dialog_message_one,
        ...
        if(dialog_message_one != null) {
	        builder.setNeutralButton(dialog_just_once,
	                new DialogInterface.OnClickListener() {
        ...
        builder.setNegativeButton(dialog_message_two,
                new DialogInterface.OnClickListener() {
